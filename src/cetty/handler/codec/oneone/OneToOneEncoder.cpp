...
namespace cetty { namespace handler { namespace codec { namespace oneone { 
...
void OneToOneEncoder::stateChangeRequested(ChannelHandlerContext& ctx, const ChannelStateEvent& e) {
    ctx.sendDownstream(e);
}
