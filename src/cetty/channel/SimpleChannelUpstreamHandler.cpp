...
InternalLogger* SimpleChannelUpstreamHandler::logger =
                    InternalLoggerFactory::getInstance("SimpleChannelUpstreamHandler");
...
void SimpleChannelUpstreamHandler::exceptionCaught(ChannelHandlerContext& ctx,
    ...
    if (this == ctx.getPipeline().getLast().get()) {
        logger->warn(
                "EXCEPTION, please implement SimpleChannelUpstreamHandler"
