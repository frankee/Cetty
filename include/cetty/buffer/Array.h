...
public:
    ...
    Array(const Array& array) : buf(array.buf), bufSize(array.bufSize) {}

    Array& operator=(const Array& array) {
        buf = array.buf;
        bufSize = array.bufSize;
        return *this;
    }
     ...
     */
    static Array fromString(std::string& string) {
...
public:
    ...
    ConstArray(const Array& array) : buf(array.data()), bufSize(array.length()) {}
    ConstArray(const ConstArray& array) : buf(array.buf), bufSize(array.bufSize) {}

    ConstArray& operator=(const ConstArray& array) {
        buf = array.buf;
        bufSize = array.bufSize;
        return *this;
    }
     ...
     * the caller must take care of the life cycle of the returned Array.
     */
    static Array clone(const ConstArray& array);
