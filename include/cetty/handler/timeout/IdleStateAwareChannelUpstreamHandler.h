#if !defined(CETTY_HANDLER_TIMEOUT_IDLESTATEAWARECHANNELUPSTREAMHANDLER_H)
#define CETTY_HANDLER_TIMEOUT_IDLESTATEAWARECHANNELUPSTREAMHANDLER_H
 ...
 */
class IdleStateAwareChannelUpstreamHandler : public cetty::channel::SimpleChannelUpstreamHandler {
public:
    /**
     * Creates a new instance.
     */
    IdleStateAwareChannelUpstreamHandler() {}
    virtual ~IdleStateAwareChannelUpstreamHandler() {}
    ...
    virtual std::string toString() const {
        return std::string("IdleStateAwareChannelUpstreamHandler");
    }
};

}}}

#endif //#if !defined(CETTY_HANDLER_TIMEOUT_IDLESTATEAWARECHANNELUPSTREAMHANDLER_H)
