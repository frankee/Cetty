...
public:
     ...
     * resource retrieval.
     */
    static const HttpMethod HM_OPTIONS;
     ...
     */
    static const HttpMethod HM_CONNECT;
    ...
    bool equals(const HttpMethod& method) const {
