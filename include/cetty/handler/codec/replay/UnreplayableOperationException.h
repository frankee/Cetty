#if !defined(CETTY_HANDLER_CODEC_REPLAY_UNREPLAYABLEOPERATIONEXCEPTION_H)
#define CETTY_HANDLER_CODEC_REPLAY_UNREPLAYABLEOPERATIONEXCEPTION_H
...
#endif //#if !defined(CETTY_HANDLER_CODEC_REPLAY_UNREPLAYABLEOPERATIONEXCEPTION_H)
