...
public:
     ...
     */
    virtual Channel* getParent() const = 0;

    /**
     * Returns the {@link ChannelFactory} which created this channel.
     */
    virtual ChannelFactory& getFactory() const = 0;
     ...
     */
    virtual ChannelPipeline& getPipeline() const  = 0;
     ...
     * for easy use.
     */
    virtual ChannelFuturePtr& getSucceededFuture() = 0;
