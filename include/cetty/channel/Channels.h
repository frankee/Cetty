...
public:
     ...
     * <tt>"2"</tt>, and so on.
     */
    static ChannelPipeline* pipeline(const ChannelHandlerPtr& handler);

    static ChannelPipeline* pipeline(const ChannelHandlerPtr& handler0,
    ...
    static ChannelPipeline* pipeline(const std::vector<ChannelHandlerPtr>& handlers);
     ...
     * {@link ChannelHandler} instance will never be created.
     */
    static ChannelPipelineFactoryPtr pipelineFactory(ChannelPipeline* pipeline);
     ...
     * {@link Channel}.
     */
    static ChannelFuturePtr future(Channel& channel) {
     ...
     */
    static ChannelFuturePtr future(Channel& channel, bool cancellable);
     ...
     */
    static ChannelFuturePtr failedFuture(Channel& channel, const Exception& cause);
     ...
     */
	static void fireChannelBound(Channel& channel, const SocketAddress& localAddress);
     ...
     */
	static void fireChannelConnected(Channel& channel, const SocketAddress& remoteAddress);
     ...
     */
	static void fireMessageReceived(Channel& channel, const ChannelMessage& message);
     ...
     *                       came from
     */
    static void fireMessageReceived(Channel& channel, const ChannelMessage& message, const SocketAddress& remoteAddress);
     ...
     * the specified {@link Channel}.
     */
	static void fireWriteCompleted(Channel& channel, long amount);
     ...
     * the specified {@link Channel}.
     */
    static void fireExceptionCaught(Channel& channel, const Exception& cause);
     ...
     */
	static ChannelFuturePtr bind(Channel& channel, const SocketAddress& localAddress);
     ...
     */
    static void bind(
            ChannelHandlerContext& ctx, const ChannelFuturePtr& future, const SocketAddress& localAddress);
     ...
     */
    static ChannelFuturePtr unbind(Channel& channel);
     ...
     */
    static ChannelFuturePtr connect(Channel& channel, const SocketAddress& remoteAddress);
     ...
     */
    static ChannelFuturePtr write(Channel& channel,
     ...
     */
    static ChannelFuturePtr setInterestOps(Channel& channel, int interestOps);
     ...
     */
    static ChannelFuturePtr disconnect(Channel& channel);
     ...
     */
    static ChannelFuturePtr close(Channel& channel);
...
private:
    static void fireChildChannelStateChanged(Channel& channel, Channel& childChannel);
