...
public:
    typedef boost::function1<void, const ChannelFuturePtr&> ListenerFunction;
...
public:
     ...
     */
    virtual void setListener(const ListenerFunction& listener) = 0;

    /**
     * Adds the specified listener to this future.  The
     * specified listener is notified when this future is
     * @link #isDone() done@endlink.  If this future is already
     * completed, the specified listener is notified immediately.
     */
     ...
     *         if the current thread was interrupted
     */
    virtual bool await(boost::int64_t timeout, const TimeUnit& unit) = 0;
     ...
     *         if the current thread was interrupted
     */
    virtual bool await(boost::int64_t timeoutMillis) = 0;
     ...
     *         the specified time limit
     */
    virtual bool awaitUninterruptibly(boost::int64_t timeout, const TimeUnit& unit) = 0;
     ...
     *         the specified time limit
     */
    virtual bool awaitUninterruptibly(boost::int64_t timeoutMillis) = 0;
};
